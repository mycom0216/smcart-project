...
class OftenAdapter(var context : Context, var data : ArrayList<RecomVO>):
    RecyclerView.Adapter<OftenAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OftenAdapter.ViewHolder {
        val inflater = LayoutInflater.from(context)
        val view = inflater.inflate(R.layout.recom_prod_list,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: OftenAdapter.ViewHolder, position: Int) {
